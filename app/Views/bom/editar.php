...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Editar Bill of Materials</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Editar Bill of Materials</h3>
                    </div>
                    <div class="card-body">
                        <form action="/bom/actualizar/<?= $bom['id'] ?>" method="post">
                            <div class="form-group">
                                <label for="nombre">Nombre</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $bom['nombre'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="descripcion">Descripción</label>
                                <textarea class="form-control" id="descripcion" name="descripcion" required><?= $bom['descripcion'] ?></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="materiaprima_fabricado_id" name="materiaprima_fabricado_id" required>
                                    ...
                                    <option value="<?= $materiaprima['id'] ?>" <?= $materiaprima['id'] == $bom['materiaprima_id'] ? 'selected' : '' ?>><?= $materiaprima['nombre'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="materiales">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" name="materiales[<?= $index ?>][materiaprima_id]" required>
                                                    <?php foreach ($materiaprimas as $materiaprima): ?>
                                                    <option value="<?= $materiaprima['id'] ?>" data-costo="<?= $materiaprima['costo_unitario'] ?>" <?= $materiaprima['id'] == $material['materiaprima_id'] ? 'selected' : '' ?>><?= $materiaprima['nombre'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control" name="materiales[<?= $index ?>][cantidad]" value="<?= $material['cantidad'] ?>" required>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control" name="materiales[<?= $index ?>][desperdicio]" value="<?= $material['desperdicio'] ?>" required>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control" name="materiales[<?= $index ?>][subtotal]" value="<?= $material['subtotal'] ?>" readonly>
                                            </td>
                                            <td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="costo_total" name="costo_total" value="<?= $bom['costo_total'] ?>" readonly>
                            </div>
...
$(document).ready(function() {
    var materialIndex = <?= count($materiales) ?>;
